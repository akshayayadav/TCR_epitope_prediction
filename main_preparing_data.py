...
vdj_dataset.write_dataset()
'''vdj_dataset.build_unseen_test_data("db/vdjdb_trb_mhc1_scorethres1/vdjdb_trb_mhc1_scorethres1_hs_pos_neg_test.csv", 
                                   pos_test_data_size=377, neg_test_data_size=115838)'''
vdj_dataset.write_dataset_parts("vdjdb_trb_mhc1_scorethres1_hs_pos_neg", "db/vdjdb_trb_mhc1_scorethres1", neg_parts_num=5)
