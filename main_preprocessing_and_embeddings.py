...
tr_b_tsv = process_tsv.VdjdbTsv('db/vdjdb_trb_mhc1_scorethres2_hs.tsv')
vdj_dict, epitope_dict = tr_b_tsv.get_vdj_and_epitope_dict(tr_bv_seqs, tr_bj_seqs)

t5_model = get_T5_embeddings.T5model()
t5_model.calculate_embeddings_vdj(vdj_dict, 100, 0)
t5_model.calculate_embeddings_epitope(epitope_dict, 100, 0)

#t5_model.calculate_embeddings_vdj(vdj_dict, 100, 1)
#t5_model.calculate_embeddings_epitope(epitope_dict, 100, 1)
